...
class CommandStepExecutor(StepExecutor):
    """Executes command steps by invoking Claude with a specific command."""
    ...
    def execute(
        ...
        for key, value in args.items():
            if isinstance(value, str) and context.renderer.has_variables(value):
                args[key] = context.renderer.render_string(value, template_context)
